...
tinydefence.maps = [

    {
        ...
        key: 'level1',
        // Path to map data
        data: 'testprojet2/assets/maps/Level1/map.json',
        // Path to map sprite
        sprite: 'testprojet2/assets/maps/Level1/map.png',
    ...
    },
    {
        ...
        key: 'BeachDefense',
        // Path to map data
        data: 'testprojet2/assets/maps/BeachDefense/map.json',
        // Path to map sprite
        sprite: 'testprojet2/assets/maps/BeachDefense/map.png',
        // Readable name for this map/level
        name: 'Beach Defense',
        // Start point for the enemies
        start: { x: 1, y: 10 },
    ...
    },
    {
        ...
        key: 'LavaDefense',
        // Path to map data
        data: 'testprojet2/assets/maps/LavaDefense/map.json',
        // Path to map sprite
        sprite: 'testprojet2/assets/maps/LavaDefense/map.png',
        // Readable name for this map/level
        name: 'Lava Defense',
        // Start point for the enemies
        start: { x: 0, y: 3 },
