...
tinydefence.maps = [

    {
        ...
        key: 'level1',
        // Path to map data
        data: 'testprojet6/assets/maps/Level1/map.json',
        // Path to map sprite
        sprite: 'testprojet6/assets/maps/Level1/map.png',
    ...
    },
    {
        ...
        key: 'BeachDefense',
        // Path to map data
        data: 'testprojet6/assets/maps/BeachDefense/map.json',
        // Path to map sprite
        sprite: 'testprojet6/assets/maps/BeachDefense/map.png',
        // Readable name for this map/level
        name: 'Beach Defense',
        // Start point for the enemies
        start: { x: 1, y: 10 },
    ...
    },
    {
        ...
        key: 'LavaDefense',
        // Path to map data
        data: 'testprojet6/assets/maps/LavaDefense/map.json',
        // Path to map sprite
        sprite: 'testprojet6/assets/maps/LavaDefense/map.png',
        // Readable name for this map/level
        name: 'Lava Defense',
        // Start point for the enemies
        start: { x: 0, y: 3 },
    ...
    },
    {
        ...
        key: 'LavaDefense2',
        // Path to map data
        data: 'testprojet6/assets/maps/LavaDefense2/map1.json',
        // Path to map sprite
        sprite: 'testprojet6/assets/maps/LavaDefense2/map1.png',
        // Readable name for this map/level
        name: 'Lava Defense 2',
        // Start point for the enemies
        start: { x: 0, y: 3 },
    ...
    },
    {
        ...
        key: 'LavaDefense3',
        // Path to map data
        data: 'testprojet6/assets/maps/LavaDefense3/map2.json',
        // Path to map sprite
        sprite: 'testprojet6/assets/maps/LavaDefense3/map2.png',
        // Readable name for this map/level
        name: 'Lava Defense 3',
        // Start point for the enemies
        start: { x: 0, y: 3 },
    ...
    },
    {
        ...
        key: 'LavaDefense4',
        // Path to map data
        data: 'testprojet6/assets/maps/LavaDefense4/map3.json',
        // Path to map sprite
        sprite: 'testprojet6/assets/maps/LavaDefense4/map3.png',
        // Readable name for this map/level
        name: 'Lava Defense 4',
        // Start point for the enemies
        start: { x: 0, y: 3 },
